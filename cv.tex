...
\ecvbibhighlight{<Second Name>}{<First Name>}{<Char>}
...
\begin{document}
  ...
  %\ecvblueitem{Altre competenze/Interessi}{Mi ritrovo spesso a sperimentare con diversi paradigmi e
  %linguaggi di programmazione, con la quale creo vari programmi.
  %Sono un utente GNU/Linux alla quale piace imparare nuove cose riguardanti
  %l'informatica ogni giorno}
